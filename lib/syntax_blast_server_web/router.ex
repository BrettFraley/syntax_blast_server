defmodule SyntaxBlastServerWeb.Router do
  ...
  import SyntaxBlastServerWeb.UserAuth
  ...
  scope "/", SyntaxBlastServerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SyntaxBlastServerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SyntaxBlastServerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SyntaxBlastServerWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SyntaxBlastServerWeb do
    ...
    live_session :current_user,
      on_mount: [{SyntaxBlastServerWeb.UserAuth, :mount_current_user}] do
